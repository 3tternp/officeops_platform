...
const EditRiskModal = ({ isOpen, onClose, onSubmit, risk }) => {
  ...
  // Load assets and populate form when risk changes
  useEffect(() => {
    if (isOpen && risk) {
      console.log('Loading risk for editing:', risk);
      ...
      setFormData({
        ...
        treatmentActionProgress: String(risk.treatmentActionProgress || '0'),
        treatmentActionStatus: risk.treatmentActionStatus || risk.treatmentStatus || 'Not Started',
        postTreatmentLikelihood: String(risk.postTreatmentLikelihood || ''),
        postTreatmentLikelihoodRationale: risk.postTreatmentLikelihoodRationale || '',
        postTreatmentImpact: String(risk.postTreatmentImpact || ''),
        postTreatmentImpactRationale: risk.postTreatmentImpactRationale || '',
        comments: risk.comments || '',
        reviewFrequency: risk.reviewFrequency || 'annually',
        nextReviewDate: risk.nextReviewDate ? risk.nextReviewDate.split('T')[0] : '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await onSubmit(updatedRiskData);
      onClose();
      setCurrentStep(1);
      
    } catch (error) {
      console.error('Error updating risk assessment:', error);
      alert('Error updating risk assessment. Please try again.');
    } finally {
    ...
    <div className="fixed inset-0 z-100 flex items-center justify-center">
      ...
      <div className="relative bg-popover border border-border rounded-lg shadow-enterprise-lg w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div>
            <h2 className="text-xl font-semibold text-popover-foreground">Edit Risk Assessment</h2>
            <p className="text-sm text-muted-foreground mt-1">
              Update the risk assessment details and treatment plan
            </p>
          </div>
